...
if(obj_house2.happiness > 0) { //Check if house has happiness
	direction = point_direction(x, y, obj_block2.x, obj_block2.y) // Set direction to the village
	speed = 0.5 // Set speed
} 
if(obj_house2.happiness <= 0) { //Check if house has no happiness
...
if(not instance_exists(obj_house2)) { // Check if house exists
	instance_destroy(obj_houseRiot2) // Destroy riot
}
