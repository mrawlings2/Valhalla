...
if(obj_house4.happiness > 0) { //Check if house has happiness
	direction = point_direction(x, y, obj_block4.x, obj_block4.y) // Set direction to the village
	speed = 0.5 // Set speed
} 
if(obj_house4.happiness <= 0) { //Check if house has no happiness
...
if(not instance_exists(obj_house4)) { // Check if house exists
	instance_destroy(obj_houseRiot4) // Destroy riot
}
